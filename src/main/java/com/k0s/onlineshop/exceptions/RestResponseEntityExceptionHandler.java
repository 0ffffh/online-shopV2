...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> internalServerError(Throwable e) {
    ...
    public ResponseEntity<ErrorMessage> productNotFoundException(ProductCartNotFoundException exception) {
